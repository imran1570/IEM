...
#loop for reading in the correlation files of leave and no leave group and making positive definite correlation matrices of them  
  ...
  for (month in given_months){
    ...
    correlated_train_leave_list[[month]] <- CorrelateData(DetectorData = as.data.frame(time_correlated_leave_train_list_original[[month]]), CopulaMatrix = as.data.frame(copula_train_leave_samples))
    ...
    correlated_train_noleave_list[[month]] <- CorrelateData(DetectorData = as.data.frame(time_correlated_noleave_train_list_original[[month]]), CopulaMatrix = as.data.frame(copula_train_noleave_samples))
  ...
  #View(cor(correlated_train_noleave_list[["2015-11"]], method = "spearman"))
